...
class EmailListener {
                        ...
                        fetch.on('message', (msg) => {
                            ...
                            msg.once('attributes', (attrs) => {
                                ...
                                imap.addFlags(uid, ['\\Seen'], (err) => {
                                    if (err)
                                        console.error('[EmailListener] Failed to mark as read:', err);
                                });
                            });
                        });
                        fetch.once('end', () => {
    ...
    async saveEmail(email) {
        ...
        const existing = await db_1.db.emailThread.findUnique({
        ...
        const thread = await db_1.db.emailThread.create({
            data: {
                from: email.from,
