export const SERVICES = [
  ...
  },
  {
    ...
    name: "AI Images",
    category: "GRAPHICS",
    description: "Custom AI-generated images using Midjourney and DALL-E 3. On-brand, high resolution, commercial rights included.",
    basePrice: 49,
    basePriceGBP: 39,
    basePriceEUR: 44,
    popular: false,
    icon: "🤖",
    features: ["Midjourney / DALL-E 3", "4K resolution", "Commercial rights", "Custom prompts", "Fast delivery"],
    packages: [
